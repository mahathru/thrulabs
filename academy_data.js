  ...
  return pulseIn(echo, HIGH) * 0.034 / 2;
    ...
    careerRoadmaps: {
        ...
        "ece": {
            ...
            courses: ["digital-electronics", "pcb-design-kicad"],
            projects: ["line-follower", "obstacle-robot"],
    ...
    resourceCollections: {
        ...
        "interview": {
            ...
            courses: ["embedded-systems", "pcb-design-kicad"],
            projects: ["rover"],
            html: `
                <div class="space-y-6">
...
#define CHK_BIT(REG, BIT)   (((REG) >> (BIT)) & 1UL)</pre>
        ...
        "notes": {
            ...
            courses: ["digital-electronics", "uav-drone-technology"],
            projects: ["line-follower"],
            html: `
                <div class="space-y-6">
        ...
        "guides": {
            ...
            courses: ["arduino-fundamentals", "esp32-iot-development"],
            projects: ["agriculture"],
            html: `
                <div class="space-y-6">
